<x-app-layout>
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex mb-3">
            <a href="{{ route('categories.export.csv', request()->query()) }}"
                class="btn btn-outline-secondary btn-sm me-1">
                <i class="bi bi-filetype-csv"></i> CSV
            </a>
            <a href="{{ route('categories.export.xlsx', request()->query()) }}"
                class="btn btn-outline-success btn-sm me-1">
                <i class="bi bi-file-earmark-excel"></i> Excel
            </a>
            <a href="{{ route('categories.export.pdf', request()->query()) }}"
        ...
        <table class="table table-bordered text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @if (Auth::user()->is_admin)
                    <td>{{ $category->user_id }}</td> {{-- NEW --}}
                    @endif
                    <td>
                        <a href="{{ route('categories.edit', $category->id) }}" class="btn btn-sm btn-warning"><i class="bi bi-pencil-square"></i> Edit</a>
